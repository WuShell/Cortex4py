...
class AnalyzersController(AbstractController):
    ...
    def run_by_id(self, analyzer_id, observable, **kwargs) -> Job:
        ...
        if observable.get('dataType') == "file":
            ...
            # If observable contains 'file_name', let's pass it
            # to cortex, otherwise use the basename of 'file_path'
            # This allows to pass temporary files with autogenerated
            # names and use an arbitrary file name.
